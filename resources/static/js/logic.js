...
//   var stations = response.geomerty;
...
//     var poiMarker = L.marker([station, station])
//       .bindPopup("<h3>" + station.store_name + "<h3><h3>Capacity: " + station.status + "<h3>");

//     // Add the marker to the pointMarkers array
//     pointMarkers.push(poiMarker);
//   }

//   // Create a layer group , pass it into the createMap function
//   createMap(L.layerGroup(pointMarkers));
// }
// // Perform an geojson Call createMarkers when complete
// d3.json("resources/map.geojson", createMarkers);
...
d3.json(dallasGeo, function(response) {
  ...
  for (var i = 0; i < response.length; i++) {
    ...
    var location = response[i].gemomerty;
